...
export function Contact() {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative grid grid-cols-1 items-end gap-16 lg:grid-cols-12"
        style={{
      ...
      >
        ...
        <div className="lg:col-span-7">
          ...
          <h2
            className="mt-10 text-pretty leading-[0.92] tracking-[-0.045em] text-white"
        ...
        {/* Right: contact links */}
        <div className="flex flex-col gap-10 lg:col-span-5 lg:items-end lg:justify-end lg:pb-3">
          <div
          ...
          >
            ...
            <TravelingLink href={`mailto:${EMAIL}`} size="lg">
              <span
            ...
            <div className="flex flex-wrap items-center gap-x-8 gap-y-2 lg:justify-end">
              {SOCIALS.map((s) => (
                <TravelingLink key={s.label} href={s.href} external size="sm">
                  <span
                    className="font-light tracking-tight text-white/85"
