  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <StatCard target={3} label="Roles" icon="🏢" delay={1450} animDelay={0} scrollTo="journey" />
      ...
      >
        ...
        <div className="flex flex-shrink-0 flex-col gap-4">
          ...
          <div
            ...
            aria-hidden
          />
          <StatCard target={3} label="Roles" icon="🏢" delay={1200} animDelay={1200} scrollTo="journey" />
          <a href="#projects" className="cursor-pointer transition-all duration-200 hover:brightness-110 hover:drop-shadow-[0_0_8px_rgba(0,255,204,0.15)]">
